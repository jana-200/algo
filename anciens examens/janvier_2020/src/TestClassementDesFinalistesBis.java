...
public class TestClassementDesFinalistesBis {

	private static java.util.Scanner scanner = new java.util.Scanner(System.in);
	private static Class classe = ClassementDesFinalistesBis.class;
	...
	public static void testsAjouter() throws IllegalAccessException {
		ClassementDesFinalistesBis gestionnaire = null;

		System.out.println("Test 1 : ajout dans des tables vides");
		System.out.println("------------------------------------");
		gestionnaire = new ClassementDesFinalistesBis(4);
		...
		System.out.println("------------------------------------------------------");
		gestionnaire = new ClassementDesFinalistesBis(5);
	...
	public static void testsEcartMaximum() throws IllegalAccessException {
		...
		System.out.println("-----------------------------");
		gestionnaire = new ClassementDesFinalistesBis(6);
